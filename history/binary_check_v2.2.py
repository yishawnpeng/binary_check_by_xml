    ...
    def get_tag_Base_form_xml(self, tag):
        ...
        try:
            ...
            if tag == "PSP_DIR":
                ...
                if xml_block_comment == "KRK1" :
                    xml_block_comment = "KRK"
                    print(f"Because of HpAmd gen xml tool issue, KRK1 need to change to KRK for match")
...
if __name__ == "__main__":
    ...
    PLATFORM_DATA = {
        ...
        "Y27": {"type": "AMD", "xml_block_comment":"KRK1", "xml_end": "32M_DDR5_FP8.xml"},
